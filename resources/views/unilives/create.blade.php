...
<div class="container mt-3">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-right alert alert-primary ">  طلب الحصول على حياة جامعية لطلاب الماجستير </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('unilives.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <label for="year" class="col-md-2 col-form-label text-md-right">عام التسجيل</label>
                        </div>
